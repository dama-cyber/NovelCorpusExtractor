...
GENRE_TEMPLATES = {
    ...
    # 核心情节
    "重生文": {"structure_type": "重生文", "base_structure": "三幕式", "special_elements": ["前世记忆", "改变命运", "预知未来", "弥补遗憾"], "key_plot_points": ["重生觉醒", "利用记忆", "改变事件", "避免悲剧", "新的人生"]},
    ...
    "系统文": {"structure_type": "系统文", "base_structure": "升级流", "special_elements": ["系统提示", "任务系统", "奖励机制", "系统升级"], "key_plot_points": ["系统激活", "接取任务", "完成任务", "获得奖励", "系统升级"]},
